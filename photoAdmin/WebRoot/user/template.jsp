...
<body onload="onloadprovince()">
   	...
   	<div class="content " role="main">
   	 <div class="form-inner">
   		...
   		<table>
   		<tr><td><strong>登录名</strong>：</td><td><input class="inputtext input_middle required" type="text" name="userInfo.userName" id="dengluming" required="required"  style="height: 20px"/></td></tr>
   		<tr><td>&nbsp;</td></tr>
   		<tr><td><strong>昵称</strong>：</td><td><input  type="text" name="userInfo.userNickname" id="nicheng" required="required" style="height: 20px"/></td></tr>
   		<tr><td>&nbsp;</td></tr>
   		<tr><td><strong>密码</strong>：</td><td><input type="password" name="userInfo.userPassword" id="mima" required="required" style="height: 20px"/></td></tr>
   		<tr><td>&nbsp;</td></tr>
   		<tr><td><strong>邮箱</strong>：</td> <td><input type="email" name="userInfo.userEmail" id="youxiang" required="required" style="height: 20px"/></td></tr> 
   		<tr><td>&nbsp;</td></tr>
   		<tr><td><strong>性别</strong>：</td>
		...
		<tr><td>&nbsp;</td></tr>
		<tr><td><strong>联系电话</strong>：</td>
		<td><input type="text" name="userInfo.userPhone"  style="height: 20px"/></td>
		</tr>
		<tr><td>&nbsp;</td></tr>
		</table>
		<table>
		<tr><td><strong>上传头像</strong>：</td>
		<td><input type="file" name="image" ></td></tr>
		</table>
   	          	<input class="btn btn-inverse" style="width: 90px; height: 40px;" type="submit" value="确定添加" />
   </form>
   </div>
   </div>
</div>
