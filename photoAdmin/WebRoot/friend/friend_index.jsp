              ...
              <div class="tab-content">
                 <div class="tab-pane fade in active" id="profile2">
                      <div class="profile-image">
                      	...
                      	<c:choose>
                      	  <c:when test="${f.userInfoByOtheruserId.userId==icons.userInfo.userId}">
                      ...
                      <div class="bottom">
                          <div class="profile-desc">
                              <a target="Conframe" href="user!listUserInfo.action?userInfo.userId=${u.userId}&otherUserInfo.userId=${f.userInfoByOtheruserId.userId}" class="profile-title">${f.userInfoByOtheruserId.userNickname}</a>
                              <a href="friend!chooseFgroup.action?fid=${f.FId}"><span class="profile-subtitle">${f.fgroupInfo.fgName}</span></a>
                          </div>
