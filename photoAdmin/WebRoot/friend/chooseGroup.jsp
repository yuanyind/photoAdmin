...
<!-- row -->
<form action="friend!chooseFgroupSet.action?fid=${fid}" method="post">
        <div class="row">
            <div class="col-sm-3 col-sm-offset-4">
                <h6 class="foo">选择好友分组</h6>
                 <!-- Dropdown Menu -->
				<select class="select_styled select_styled_red" name="fgInfo.fgId" >
						<option value="${friend.fgroupInfo.fgId}">${friend.fgroupInfo.fgName}</option>
						<c:forEach items="${fgroups}" var="f">
							<c:if test="${friend.fgroupInfo.fgId!=f.fgId}">
