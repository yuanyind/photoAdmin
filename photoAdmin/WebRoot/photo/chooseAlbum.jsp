...
<form action="photo!makeChangeAlbum.action?photoInfo.PId=${photoInfo.PId}" method="post">
        <div class="row">
            ...
            <div class="col-sm-3  col-sm-offset-4">
				...
				<select class="select_styled select_styled_red" name="albumId" >
						<option value="${photoInfo.albumInfo.AId}">${photoInfo.albumInfo.AName}</option>
							<c:forEach items="${albums}" var="a">
								<c:if test="${photoInfo.albumInfo.AId!=a.AId}">
