...
<%UserInfo user = (UserInfo)session.getAttribute("u"); %>
	...
	<form action="download!downLoadZip.action" method="post">
		 ...
		 <h6 class="foo">搜索到的相片&nbsp;关键词:${searchCon}</h6>
		 </div>
		 <div class="row">
   ...
   <div class="col-sm-4 col-sm-offset-1">
		 ...
		 <h6 class="foo">搜索到的相册&nbsp;关键词:${searchCon}</h6>
		 </div>
    <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
              ...
              <div class="col-sm-3 ">
                ...
                <strong>
                	<c:choose>
							...
							<c:otherwise><a href="user!listUserInfo.action?otherUserInfo.userId=${as.userInfo.userId}">${as.userInfo.userName}</a></c:otherwise>
					</c:choose>的相册	
				</strong>
